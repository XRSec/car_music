...
### 📚 课程管理
- **智能分类**：按歌曲数量自动分为三类（有两首、有一首、没有歌曲）
- **折叠功能**：每个分类都可以折叠收起，界面更整洁
- **一行显示**：`📚 课程标题 | 📁 文件名 | 🎤 艺术家 | ⏱️ 时长    ▶️ 播放`
- **空位上传**：两个空位并排在一行，支持直接点击或拖拽上传
- **内嵌播放**：增强的悬浮播放器，显示歌曲信息和封面图标

### 🎵 歌曲管理
- **折叠界面**：添加歌曲、删除歌曲、歌曲列表都支持折叠
- **批量拖拽**：支持多文件拖拽上传，防重复添加
- **一行显示**：`🎵 友好名称 | 📁 文件名 | 🎤 艺术家 | 📅 年份    ▶️ 播放`
- **内嵌播放**：歌曲列表中每首歌都有播放按钮

### 🔧 工具页面
- **批量重命名**：一键重命名为播放器友好格式
- **一键还原**：复制所有文件到 music/ 文件夹并还原原始名称
- **歌曲查询**：快速查找指定歌曲的详细信息
- **折叠界面**：所有工具都支持折叠收起
